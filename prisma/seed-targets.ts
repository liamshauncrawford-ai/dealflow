...
async function main() {
  ...
  const targets = [
    ...
    },
    {
      ...
      employees: 4,
      primaryTrade: "STRUCTURED_CABLING" as const,
      secondaryTrades: ["SECURITY_SURVEILLANCE" as const],
    ...
    },
    {
      ...
      secondaryTrades: ["HVAC_CONTROLS" as const],
      certifications: ["Distech Controls Factory Certified"],
      dcCertifications: ["BACnet Compatible"],
      dcRelevanceScore: 8,
      dcExperience: true,
      dcClients: [],
    ...
    },
    {
      ...
      employees: 10,
      primaryTrade: "MANAGED_IT_SERVICES" as const,
  ...
  for (const target of targets) {
    ...
    const scoreResult = computeFitScore({
      ...
      dcCertifications: listingData.dcCertifications,
      dcRelevanceScore: listingData.dcRelevanceScore,
      askingPrice: null,
      ebitda: null,
      inferredEbitda: null,
